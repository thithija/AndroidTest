...
public class Mydatabase extends SQLiteOpenHelper {
    ...
    public void getAllStudent(){
        ...
        if (cursor.moveToFirst()){
            do {
                Log.d(TAG, "getAllStudent: "+"Name: "+cursor.getString(cursor.getColumnIndex(STUDENT_NAME))+"Age: "+cursor.getString(cursor.getColumnIndex(STUDENT_AGE))+"MARKS: "+cursor.getString(cursor.getColumnIndex(STUDENT_MARKS)));
